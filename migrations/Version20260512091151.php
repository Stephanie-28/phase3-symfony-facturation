 ...
 */
final class Version20260512091151 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client ADD COLUMN name VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE client ADD COLUMN email VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE client ADD COLUMN phone VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE client ADD COLUMN adresse VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE client ADD COLUMN siret VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE client ADD COLUMN rib VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__client AS SELECT id FROM client');
        $this->addSql('DROP TABLE client');
        $this->addSql('CREATE TABLE client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)');
        $this->addSql('INSERT INTO client (id) SELECT id FROM __temp__client');
